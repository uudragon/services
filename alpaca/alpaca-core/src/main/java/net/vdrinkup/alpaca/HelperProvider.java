...
public abstract class HelperProvider {
	...
	private static String getImplementationName() {
		...
		if ( implementationName == null || "".equals( implementationName ) ) {
			implementationName = Env.getInstance().getProperty( PROPERTY_NAME, String.class );
		}
	 ...
	 * @return
	 */
	public abstract FlowEngine getFlowEngine();
	 ...
	 * @return
	 */
	public abstract DataContextFactory getContextFactory();
